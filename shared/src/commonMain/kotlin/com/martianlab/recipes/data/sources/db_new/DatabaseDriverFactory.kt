...
//expect  fun databaseDriver() : SqlDriver?

expect fun createDb() : AppDatabase?

class DatabaseDriverFactory() : DbApi {
...
//        driver = SqlDriver,
//        recipeCommentEntityAdapter = RecipeCommentEntity.Adapter(photoURLsAdapter = listOfStringsAdapter)
//    )
    val db = createDb()!!
